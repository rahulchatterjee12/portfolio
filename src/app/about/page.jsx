            ...
            <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
                ...
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        ...
                        {/* SUMMARY DESC */}
                        <p className="text-lg">
                            Experienced Full Stack Developer proficient in frontend and backend technologies.
                            Skilled in HTML, CSS, JavaScript, React.js, Next.js, Redux, Node.js, Django Rest
                            Framework and MongoDB. Strong understanding of RESTful APIs and collaborative team
                            player. Passionate about staying updated with latest web trends.
                        </p>
                        {/* SUMMARY QUOTE */}
                        ...
                        >
                            ...
                            <div className="flex justify-between h-80">
                                ...
                                <div className="w-1/3 ">
                                    ...
                                    <div className="p-3 text-sm italic">
                                        Led the creation of responsive web applications with React, Next.js, Material UI, and Tailwind CSS, implementing
                                        Redux for efficient state management and seamlessly integrating RESTful APIs.
                                    </div>
                                    {/* JOB DATE */}
                            ...
                            <div className="flex justify-between h-96">
                                ...
                                <div className="w-1/3 ">
                                    ...
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">
                                        Spearheaded the integration of a WhatsApp chatbot utilizing Python and 360 Dialog API
                                        (WhatsApp API service). Innovatively developed and implemented a new loan inquiry section
                                        within the chatbot, enhancing user engagement and functionality.
                                    </div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">
                                        Dec 2022-Jan 2023
